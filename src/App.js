    ...
    <div className="App" style={{ margin: '0', padding: '0', top: '0' }}>
      ...
      <div className="trending" style={{ margin: '-10px auto 0 120px' }}>
        ...
        <div style={{ display: 'flex', width: '90%' }}>
          ...
          <h2 style={{top: '54px', position: 'relative', margin: '-31px 0 0 25px', color: 'white'}}>New Delhi</h2>
          ...
          <div style={{ width: '50%', margin: '20px 5px 10px 0', borderRadius: '.4rem', padding: '0 7px' }}>
          <h2 style={{top: '54px', position: 'relative', margin: '-31px 0 0 25px', color: 'white'}}>Bangalore</h2>
        ...
        <div style={{ display: 'flex', width: '90%', margin: '-15px 0 0 0' }}>
          ...
          <h2 style={{top: '54px', position: 'relative', margin: '-31px 0 0 25px', color: 'white'}}>Mumbai</h2>
          ...
          <div style={{ width: '33%', margin: '20px 5px 10px 0', borderRadius: '.4rem', padding: '0 7px' }}>
          <h2 style={{top: '54px', position: 'relative', margin: '-31px 0 0 25px', color: 'white'}}>Chennai</h2>
          ...
          <div style={{ width: '33%', margin: '20px 5px 10px 0', borderRadius: '.4rem', padding: '0 7px' }}>
          <h2 style={{top: '54px', position: 'relative', margin: '-31px 0 0 25px', color: 'white'}}>Hyderabad</h2>
