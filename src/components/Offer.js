      ...
      <div className="offer-section" style={{ margin: '50px auto 0 120px' }}>
        ...
        <div style={{ display: 'flex', width: '90%' }}>
          <div style={{ width: '50%', border: '1px solid grey', margin: '20px 5px 10px 0', borderRadius: '.4rem', padding: '0 7px' }}>
            ...
            <button style={{ height: '35px', backgroundColor: 'rgb(0,102,255)', color: 'white', border: 'rgb(0,62,255)', borderRadius: '.3rem' }}>Search for flights</button>
          </div>
          ...
          <div style={{ width: '50%', border: '1px solid grey', margin: '20px 0 10px 5px', borderRadius: '.4rem', padding: '5px 7px' }}>
            ...
            <button style={{ height: '35px', backgroundColor: 'rgb(0,102,255)', color: 'white', border: 'rgb(0,62,255)', borderRadius: '.3rem' }}>Find late escape deals</button>
          </div>
        </div>
      </div>
