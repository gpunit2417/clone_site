    ...
    <div>
        <div className="header" style={{ backgroundColor: 'rgb(0,60,145)', color: 'white' }}>
            ...
            <div className="main" style={{margin: '-10px 505px'}}>
                ...
                <button style={{margin: '10px 0 18px 0', backgroundColor: 'rgb(13, 110, 253)', color: 'white', border: '1px solid rgb(13, 110, 253)', borderRadius: '5px', height: '7.5vh', width: '25vw', cursor: 'pointer'}}>Continue with email</button>
                ...
                <div style={{display: 'flex'}}>
                    <div>
                        <img src="https://cdn2.hubspot.net/hubfs/53/image8-2.jpg" alt="" style={{height: '50px', width: '50px'}}/>
                    </div>
                    <div>
                        <img src="https://www.tailorbrands.com/wp-content/uploads/2021/01/apple_logo_1988.jpg" alt="" style={{height: '50px', width: '50px'}}/>
                    </div>
                    <div>
                        <img src="https://seekvectors.com/files/download/600dde92dc87c2bf714117db0fa6c8ce.jpg" alt="" style={{height: '50px', width: '50px'}}/>
                    </div>
                </div>
            </div>
